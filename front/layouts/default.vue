...
const links = [
  { label: 'Dashboard', to: '/dashboard/professional', icon: 'i-heroicons-home' },
  { label: 'Agenda', to: '/appointments', icon: 'i-heroicons-calendar-days' },
  { label: 'Pacientes', to: '#', icon: 'i-heroicons-users' },
  {
    label: 'Servicios',
    to: '/admin/services',
  ...
  <div class="min-h-screen bg-slate-100 text-slate-900">
    <aside class="fixed inset-y-0 left-0 z-30 hidden w-72 border-r border-slate-200 bg-white lg:flex lg:flex-col">
      ...
      <nav class="flex-1 space-y-1 px-4 py-5">
        ...
        >
          <UIcon :name="link.icon" class="h-5 w-5 shrink-0" />
      ...
      <div class="border-t border-slate-100 p-4">
        <div class="mb-3 flex items-center gap-3 rounded-lg bg-slate-50 p-3">
          <UAvatar :text="userInitial" size="md" />
          <div class="min-w-0">
